...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, kernel_size: float, \
            scaling_modifier = 1.0, visible_mask=None, retain_grad=False, subpixel_offset=None):
    """
    Render the scene. 
