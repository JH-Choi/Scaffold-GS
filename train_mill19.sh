...
# GS_TYPE=gs_mesh
# DATA_NAME=MegaMesh
# MODEL_NAME=ScaffoldMeshGSwOctree
# OUTPUT_FOLDER=outputs/building/ScMeshGSwOctree_7_app0
...
GS_TYPE=gs_mesh
DATA_NAME=MegaMesh
MODEL_NAME=ScaffoldMeshGSwNgp
OUTPUT_FOLDER=outputs/building/ScMeshGSwNgp_7_app0
